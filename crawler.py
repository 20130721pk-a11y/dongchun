...
KEYWORDS = {
    ...
    "업계": [
        "모바일게임", "콘솔게임", "스팀", "STEAM", "신작", "게임사",
        "서비스종료", "PC게임", "사전예약", "런칭", "얼리액세스",
        "모바일게임 순위", "게임 매출", "지스타", "서머게임페스트"
    ]
}
...
def crawl():
    ...
    naver_keywords = {
        ...
        "업계": ["모바일게임 신작", "게임사 신작", "서비스종료 게임", "PC게임 런칭", "게임 사전예약", "모바일게임 순위", "게임 매출 순위"]
    }
